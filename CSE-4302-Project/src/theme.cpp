...
void ThemeManager::applyTheme(QApplication &a, const AppTheme &theme)
{
    ...
    QString qss = QString(
        ...
        "  color:%1; border:none; border-radius:22px;"
        "  padding:11px 26px; font-weight:700; letter-spacing:0.8px;"
        ...
        "  background-color:%2; color:%3; border:1.5px solid %4; border-radius:22px; }"
        ...
        "  padding:11px 16px; background-color:%2; color:%3; }"
        "QLineEdit:focus {"
        "  border:2px solid %4;"
        ...
        "QComboBox {"
        "  border:1.5px solid %4; border-radius:14px;"
        "  padding:10px 14px; background-color:%2; color:%3; }"
        ...
        "QHeaderView::section {"
        "  background: qlineargradient(x1:0,y1:0,x2:0,y2:1,stop:0 %2,stop:1 %1);"
        "  padding:11px 10px; border:none; border-bottom:2px solid %4;"
        ...
        "QTableWidget::item { padding:9px; border-bottom:1px solid %2; }"
        "QTableWidget::item:hover { background-color:%2; }"
        "QTableWidget::item:selected {"
        "  background: qlineargradient(x1:0,y1:0,x2:1,y2:0,stop:0 %4,stop:1 %2); color:%1; }"
        "QTableView::item { padding:9px; border-bottom:1px solid %2; }"
        "QTableView::item:hover { background-color:%2; }"
        "QTableView::item:selected {"
        "  background: qlineargradient(x1:0,y1:0,x2:1,y2:0,stop:0 %4,stop:1 %2); color:%1; }"
        "QListWidget::item { padding:10px; margin:3px 6px; border-radius:12px; }"
        "QListWidget::item:selected {"
        "  background: qlineargradient(x1:0,y1:0,x2:1,y2:0,stop:0 %4,stop:1 %2);"
        "  color:%1; border-radius:12px; }"
        "QListWidget::item:hover:!selected { background-color:%2; border-radius:12px; }"
        ...
        "  { background:%4; border-radius:3px; min-height:32px; min-width:32px; }"
